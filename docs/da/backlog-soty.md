...
| # | quoi | pourquoi | oracle | effort | decision |
| --- | --- | --- | --- | --- | --- |
| N1 | **Une ligne de seuil par direction** (mecanique posee le 11/09 : `seuil-line.tsx`, message de statut pendant le voyage, ligne conservee en tete de page, cinq entrees `common.seuils` VIDES dans les trois dictionnaires jusqu'a la relecture des brouillons de `docs/da/lignes-de-seuil.md`, au vouvoiement), a la deuxieme personne, dans le cadre nepantla, qui relie ce qu'on quitte a ce qu'on rejoint (tonalli recu au Centre, teyolia qui voyage vers Memoire) : cinq lignes, trois langues, vocabulaire du Codex | « une seule idee defendue » d'un bout a l'autre (Metabole, Utsubo) ; le fil est aujourd'hui implicite | les cinq lignes ecrites et relues par toi ; parite des dictionnaires | S | Sylvain (les textes) |

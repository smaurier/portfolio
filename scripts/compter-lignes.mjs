/**
 * Compter les lignes comme `max-lines` d'ESLint et comme `wc -l` sur un
 * fichier termine par un retour a la ligne : la ligne vide apres le
 * dernier retour a la ligne ne compte pas (mesure du 22/09 :

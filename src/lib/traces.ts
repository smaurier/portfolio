...
// "veille" (13/09) : 52 secondes de contemplation, la ligature des annees.
export const TRACE_IDS = ["centzon-thrown", "huitzilin-catch", "sunrise", "xiuhcoatl-strike", "glyph-lit", "xolotl", "true-north", "veille"] as const;
